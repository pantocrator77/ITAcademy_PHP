...
CREATE TABLE IF NOT EXISTS `mydb`.`pizzas` (
  ...
  `Pedidos_Pizzerias_id` INT NOT NULL,
  PRIMARY KEY (`id`, `Pedidos_id`, `Pedidos_Pizzerias_id`),
  INDEX `fk_pizzas_Pedidos1_idx` (`Pedidos_id` ASC, `Pedidos_Pizzerias_id` ASC) VISIBLE,
  CONSTRAINT `fk_pizzas_Pedidos1`
    FOREIGN KEY (`Pedidos_id` , `Pedidos_Pizzerias_id`)
    REFERENCES `mydb`.`Pedidos` (`id` , `Pizzerias_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`hamburguesas` (
  ...
  `precio` VARCHAR(45) NULL,
  `foto` VARCHAR(45) NULL,
  `Pedidos_id1` INT NOT NULL,
  PRIMARY KEY (`idhamburguesas`, `Pedidos_id1`),
  INDEX `fk_hamburguesas_Pedidos2_idx` (`Pedidos_id1` ASC) VISIBLE,
  CONSTRAINT `fk_hamburguesas_Pedidos2`
    FOREIGN KEY (`Pedidos_id1`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`bebidas` (
  ...
  `foto` VARCHAR(45) NULL,
  `Pedidos_id` INT NOT NULL,
  PRIMARY KEY (`idbebidas`, `Pedidos_id`),
  INDEX `fk_bebidas_Pedidos1_idx` (`Pedidos_id` ASC) VISIBLE,
  CONSTRAINT `fk_bebidas_Pedidos1`
